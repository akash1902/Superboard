...
const etherscan_module_1 = require("../common/etherscan.module");
...
exports.ContractsModule = ContractsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([contract_entity_1.Contract]), etherscan_module_1.EtherscanModule],
