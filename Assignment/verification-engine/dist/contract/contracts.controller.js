...
let ContractsController = class ContractsController {
    ...
    async analyzeTransactions(contractId) {
...
__decorate([
    (0, common_1.Get)(':contractId/transactions'),
    __param(0, (0, common_1.Param)('contractId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContractsController.prototype, "analyzeTransactions", null);
__decorate([
    (0, common_1.Post)('evaluate'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [evaluation_dto_1.EvaluateTransactionDto]),
    __metadata("design:returntype", Promise)
], ContractsController.prototype, "evaluateTransaction", null);
